...
class MLforKidsImageProject:
    ...
    def __get_training_images_generator(self):
        ...
        for trainingitem in self.__downloaded_training_images_list:
            try:
                ...
                print(downloaderr)
                print(
                    "ERROR: Skipping training image and continuing without it",
                    trainingitem["imageurl"])
    ...
    def __get_class_lookup(self, training_image_data):
        ...
        for classname in class_names:
            class_labels[
                training_image_data.class_indices[classname]] = classname
        return class_labels
    ...
    def __define_model(self):
        ...
        model = Sequential([
            ...
            Rescaling(1 / 127,
                      input_shape=MLforKidsImageProject.INPUTLAYERSIZE),
    ...
    def __train_model(self, trainingimagesdata):
        ...
        if trainingimagesdata.samples > 55:
            epochs = 15
        self.ml_model.fit(trainingimagesdata,
                          epochs=epochs,
    ...
    def prediction(self, image_location: str):
        ...
        testimg = image.load_img(image_location,
